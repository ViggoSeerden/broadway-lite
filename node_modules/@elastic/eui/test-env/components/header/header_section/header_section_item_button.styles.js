...
var euiHeaderSectionItemButtonStyles = function euiHeaderSectionItemButtonStyles(euiThemeContext) {
  var _euiHeaderVariables = (0, _header.euiHeaderVariables)(euiThemeContext),
    childHeight = _euiHeaderVariables.childHeight;
  var euiTheme = euiThemeContext.euiTheme;
  return {
    euiHeaderSectionItemButton: /*#__PURE__*/(0, _react.css)("position:relative;", (0, _global_styling.logicalCSS)('height', childHeight), " ", (0, _global_styling.logicalCSS)('min-width', childHeight), " text-align:center;font-size:0;", (0, _global_styling.euiMaxBreakpoint)(euiThemeContext, 's'), "{", (0, _global_styling.logicalCSS)('min-width', (0, _global_styling.mathWithUnits)(childHeight, function (x) {
      return x * 0.75;
    })), ";};label:euiHeaderSectionItemButton;"),
    euiHeaderSectionItemButton__content: _ref2,
    notification: {
      euiHeaderSectionItemButton__notification: _ref,
      dot: /*#__PURE__*/(0, _react.css)((0, _global_styling.logicalCSS)('top', 0), " ", (0, _global_styling.logicalCSS)('right', 0), " stroke:", euiTheme.colors.emptyShade, ";", (0, _global_styling.euiMaxBreakpoint)(euiThemeContext, 's'), "{", (0, _global_styling.logicalSizeCSS)(euiTheme.size.base), " ", (0, _global_styling.logicalCSS)('top', '9%'), ";};label:dot;"),
      badge: /*#__PURE__*/(0, _react.css)((0, _global_styling.logicalCSS)('top', '9%'), " ", (0, _global_styling.logicalCSS)('right', '9%'), " box-shadow:0 0 0 ", euiTheme.border.width.thin, " ", euiTheme.colors.emptyShade, ";;label:badge;")
    }
  };
};
exports.euiHeaderSectionItemButtonStyles = euiHeaderSectionItemButtonStyles;