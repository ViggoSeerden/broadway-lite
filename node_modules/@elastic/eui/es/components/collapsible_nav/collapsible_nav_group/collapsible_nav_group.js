...
export var BACKGROUNDS = ['none', 'light', 'dark'];
export var EuiCollapsibleNavGroup = function EuiCollapsibleNavGroup(_ref) {
  ...
  if (isCollapsible && title) {
    render = ___EmotionJSX(EuiAccordion, _extends({
      id: groupID,
      css: cssStyles,
      className: classes,
    ...
    render = ___EmotionJSX("div", _extends({
      id: groupID,
      css: cssStyles,
      className: classes
  ...
  return background === 'dark' ? ___EmotionJSX(EuiThemeProvider, {
    colorMode: "dark",
    wrapperProps: {
      cloneElement: true
    }
