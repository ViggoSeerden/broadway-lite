...
var EuiContextMenuPanelClass = /*#__PURE__*/function (_Component) {
  ...
  function EuiContextMenuPanelClass(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "initialPopoverParent", null);
    // Find all tabbable menu items on both panel init and
    // whenever `menuItems` resets when `props.items` changes
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "findMenuItems", function () {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "focusMenuItem", function (direction) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "reclaimPopoverFocus", function () {
      _this.setState({
