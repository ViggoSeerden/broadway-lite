...
var EuiListGroup = function EuiListGroup(_ref) {
  ...
  if (listItems) {
    childrenOrListItems = listItems.map(function (item, index) {
      return [(0, _react2.jsx)(_list_group_item.EuiListGroupItem, _extends({
  ...
  return (0, _react2.jsx)("ul", _extends({
    className: classes,
    css: cssStyles,
    style: newStyle,
...
EuiListGroup.propTypes = {
  ...
  /**
       ...
       */
  maxWidth: _propTypes.default.oneOfType([_propTypes.default.bool.isRequired, _propTypes.default.any.isRequired]),
  /**
