...
var EuiDataGridCellContent = /*#__PURE__*/(0, _react.memo)(function (_ref) {
  ...
  var cellContent = (0, _react2.jsx)("div", {
    ...
    className: classes
  }, (0, _react2.jsx)(CellElement, _extends({
    isDetails: false,
...
var EuiDataGridCell = /*#__PURE__*/function (_Component) {
  ...
  function EuiDataGridCell() {
    ...
    _defineProperty(_assertThisInitialized(_this), "popoverAnchorRef", /*#__PURE__*/(0, _react.createRef)());
    ...
    _defineProperty(_assertThisInitialized(_this), "handleCellPopover", function () {
      if (_this.isPopoverOpen()) {
        ...
        var popoverContent = (0, _react2.jsx)(PopoverElement, _extends({}, sharedProps, {
...
EuiDataGridCell.propTypes = {
  ...
  isExpandable: _propTypes.default.bool.isRequired,
  className: _propTypes.default.string,
  popoverContext: _propTypes.default.shape({
    popoverIsOpen: _propTypes.default.bool.isRequired,
    // Note that the rowIndex used to locate cells internally is a `visibleRowIndex`
    cellLocation: _propTypes.default.shape({
      rowIndex: _propTypes.default.number.isRequired,
      colIndex: _propTypes.default.number.isRequired
    }).isRequired,
    ...
    setPopoverAnchorPosition: _propTypes.default.func.isRequired,
