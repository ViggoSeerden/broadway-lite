...
var EuiCollapsedNavItem = function EuiCollapsedNavItem(_ref) {
  ...
  return items ? (0, _react2.jsx)(_collapsed_nav_popover.EuiCollapsedNavPopover, _extends({
    items: items,
    className: classes
  }, props)) : (0, _react2.jsx)(_collapsed_nav_button.EuiCollapsedNavButton, _extends({
    href: href,
    linkProps: linkProps,
    className: classes
  }, props));
