...
var EuiCommentList = function EuiCommentList(_ref) {
  ...
  if (comments) {
    commentElements = comments.map(function (item, index) {
      return (0, _react2.jsx)(_comment.EuiComment, _extends({
        key: index
      }, item));
    });
  }
  return (0, _react2.jsx)(_timeline.EuiTimeline, _extends({
    className: classes,
...
EuiCommentList.propTypes = {
  ...
  comments: _propTypes.default.arrayOf(_propTypes.default.shape({
    ...
    /**
       ...
       */
    timelineAvatarAriaLabel: _propTypes.default.string
  }).isRequired),
  /**
